...
## [auto-2026-07-02] - 2026-07-02
### Changed
- Updated **exchange-connector** image from **1.9.0 ➜ 1.10.0**.
- Updated **main-app** image from **1.23.1 ➜ 1.23.2**.
- Updated **frontend** image from **2.22.0 ➜ 2.23.0**.
- Updated **admin-sh** image from **1.1.0 ➜ 1.2.0**.
